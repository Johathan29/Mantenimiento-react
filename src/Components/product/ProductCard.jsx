  ...
  return (
    <>
        ...
        {products.map((product, index) => (
          <div
            key={index}
            className="rounded-xl text-card-foreground bg-gradient-to-br from-[#061024] to-[#0b244d] shadow-[2px_7px_9px_4px,0_8px_1px_3px] shadow-black/20 transition-all duration-200 hover:scale-[1.01] flex flex-col justify-between"
            ...
            <div className="p-6 flex flex-col gap-4">
              ...
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-3">
                <div className="flex flex-col flex-1">
                  ...
                  <h4 className="text-xl font-semibold text-white/70 mb-1">
                    {product.Name}
                  </h4>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-3 mt-3">
                <Metric
                  ...
                  color="green"
                />
                <Metric label="Stock" value={product.Amount.toLocaleString('en-US', { })} color="blue" />
                <Metric
                  label="Valor Total"
                  value={new Intl.NumberFormat("en-US", {
                    style: "currency",
      ...
      {/* Modal */}
      {isModalOpen && (
        <div className="fixed top-0 left-0 w-full h-full bg-[#2726265c] flex justify-center items-center z-50 p-4">
