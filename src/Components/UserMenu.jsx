          ...
          {currentUser ? (
            ...
            <AnimatePresence mode="wait">
              ...
              {/* 🔥 Sin cambios para no alterar animaciones */}
               ...
               showRegister ? ( 
               <motion.form key="register" initial={{ opacity: 0, x: 70, scale: 0.9 }} animate={{ opacity: 1, x: 0, scale: 1 }} exit={{ opacity: 0, x: -70, scale: 0.9 }} transition={{ type: "spring", stiffness: 120, damping: 12, mass: 0.8 }} className="relative z-10 space-y-6 p-4 sm:p-6 md:p-8" onSubmit={handleRegister} > 
