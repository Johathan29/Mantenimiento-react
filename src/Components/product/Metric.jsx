function Metric({ label, value, color }) {
  const colors = {
    ...
    blue: {classContent:"bg-blue-50  border-blue-200 ",classTitle:"text-md font-medium  text-blue-600 ",classCantidad:"text-xl  font-bold  text-blue-900 "},
  ...
  return (
    <div className={`p-3 rounded-lg border ${colors[color].classContent}`}>
      ...
      <p className={colors[color].classCantidad}>{value}</p>
    </div>
  );
}
